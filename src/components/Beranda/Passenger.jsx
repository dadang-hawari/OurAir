...
export const Passengers = () => {
  ...
  return (
    <div className="flex gap-x-8 w-full">
      <ReactModal isOpen={isModalOpenPassenger} onRequestClose={closeModalPassenger} style={customStyles} className="border-none relative mx-20 overflow-hidden">
        <div className="text-center bg-white p-4 rounded-md relative">
          ...
          <div className="flex flex-wrap gap-6 mt-5 justify-center">
            ...
            <div className="flex justify-end w-full">
              <button className="bg-blue-600 text-white p-2 text-lg rounded-md" onClick={confirmPassenger}>
                Simpan
              </button>
            </div>
          </div>
      ...
      <div className="flex gap-x-4 w-full">
        <div className="w-full">
          ...
          <button onClick={openModalPassenger} className="text-left my-2 text-sm font-[600] bg-white w-max  rounded-md">

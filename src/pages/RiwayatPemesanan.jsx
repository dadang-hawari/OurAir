    ...
    <div className="max-w-5xl px-5 mx-auto">
      ...
      <div className="text-sm mt-4 flex gap-5 flex-col md:flex-row w-full">
        ...
        <div className="w-full md:max-w-[376px]">
          ...
          <div className="my-2">
            Booking Code: <span className="text-accent font-bold">6723y2GH3</span>
          </div>
          <div className="flex justify-between">
            <b className="font-bold">19:10</b>
            <b className="text-soft-blue text-xs">Keberangkatan</b>
          </div>
          ...
          <div className="text-sm">
            ...
            <div className="flex items-center gap-x-2">
              ...
              <div className="w-full">
                ...
                <div>
                  <b>Informasi:</b>
                  <p className="text-accent font-[600]">Penumpang 1: Mr. Harr</p>
                  <p>ID: 12344</p>
                  <p className="text-accent font-[600]">Penumpang 2: Miss her</p>
                  <p>ID: 12341243423</p>
                </div>
              </div>
            </div>
